...
import java.io.File;
public class StuPerActivity extends AppCompatActivity {
    EditText edt1;
    EditText edt2;
    EditText edt3;
    ...
    private void request() {//查询信息
        try {
            String baseUrl = "http://47.107.62.150:8080/admin/allGra";
            URL url = new URL(baseUrl);
            HttpURLConnection urlConn = (HttpURLConnection) url.openConnection();
            urlConn.setConnectTimeout(5 * 1000);
            urlConn.setReadTimeout(5 * 1000);
            ...
            Intent intent=new Intent(StuPerActivity.this,InMessageActivity.class);
    ...
    private void initTask(){
        asyncTask = new AsyncTask() {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                urlString = "http://47.107.62.150:8080/admin/add";
                Toast.makeText(StuPerActivity.this, "开始上传", Toast.LENGTH_SHORT).show();
            }
    ...
    private void requestTpid() {//删除信息
        try {
            String baseUrl = "47.107.62.150:8080/admin/addGra";
            URL url = new URL(baseUrl);
            HttpURLConnection urlConn = (HttpURLConnection) url.openConnection();
            urlConn.setConnectTimeout(5 * 1000);
            urlConn.setReadTimeout(5 * 1000);
            ...
            DataOutputStream out = new DataOutputStream(urlConn.getOutputStream());
            JSONObject obj = new JSONObject();
            obj.put("xh",edt1.getText().toString());
            System.out.println(obj);
