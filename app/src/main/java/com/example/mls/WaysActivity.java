...
public class WaysActivity extends AppCompatActivity {
    ...
    private void change(){
        try {
            String baseUrl = "http://47.107.62.150:8080/admin/upDirect";
            ...
            obj.put("info",edt3.getText().toString());
    ...
    private void request() {
        try {
            String baseUrl = "http://47.107.62.150:8080/admin/All/Dir";
            URL url = new URL(baseUrl);
            HttpURLConnection urlConn = (HttpURLConnection) url.openConnection();
            urlConn.setConnectTimeout(5 * 1000);
            urlConn.setReadTimeout(5 * 1000);
            ...
            Intent intent=new Intent(WaysActivity.this,InMessageActivity.class);
    ...
    private void initTask(){
        asyncTask = new AsyncTask() {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                urlString = "http://47.107.62.150:8080/admin/add";
                Toast.makeText(WaysActivity.this, "开始上传", Toast.LENGTH_SHORT).show();
            }
    ...
    private void requestTpid() {
        try {
            String baseUrl = "http://47.107.62.150:8080/admin/toupDirect";
            URL url = new URL(baseUrl);
            HttpURLConnection urlConn = (HttpURLConnection) url.openConnection();
            urlConn.setConnectTimeout(5 * 1000);
            urlConn.setReadTimeout(5 * 1000);
